...
/// <summary>
/// Covers the <see cref="BlockBasedTableOptions"/> members added in RocksDb
/// 11.8.1, plus the pre-existing settings that only became round-trippable once
/// 11.8.1 supplied their getters. See issue #25.
/// </summary>
public class BlockBasedTableOptions118Tests
{
