...
public class DatabaseOperationsTests
{
    ...
    /// work is resumed. This asserts the pause actually takes effect rather than
    /// just not throwing.
    /// </summary>
    [Fact]
    public void PauseBackgroundWork_PreventsBackgroundFlush()
    {
        ...
        // A tiny write buffer means the writes below would normally trigger a
        // background flush on their own.
